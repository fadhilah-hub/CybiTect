...
class MydocChatHgOneScreen extends StatelessWidget {
  MydocChatHgOneScreen({Key? key})
      : super(
          key: key,
        );

  TextEditingController communicationSectionController =
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        bottomNavigationBar: _buildCommunicationSection(context),
      ),
    );
  }
  ...
  Widget _buildCommunicationSection(BuildContext context) {
    return Padding(
      ...
      child: CustomTextFormField(
        controller: communicationSectionController,
